...
public class LTUBluetoothInstance implements IBluethoothInstance{
    ...
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_GATT_CHARACTERISTIC_READ = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_CHARACTERISTIC_READ";
    public final static String ACTION_GATT_CHARACTERISTIC_WRITE = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_CHARACTERISTIC_WRITE";
    public final static String ACTION_GATT_DESCRIPTOR_READ = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_DESCRIPTOR_READ";
    public final static String ACTION_GATT_DESCRIPTOR_WRITE = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_DESCRIPTOR_WRITE";
    public final static String ACTION_GATT_MTU_WRITE = "com.rk.commonlib.bluetooth.LTUBluetoothInstance.ACTION_GATT_MTU_WRITE";
    ...
    private static class InstanceHolder {
        private static final LTUBluetoothInstance INSTANCE = new LTUBluetoothInstance();
    }

    public static LTUBluetoothInstance getInstance(Context context) {
