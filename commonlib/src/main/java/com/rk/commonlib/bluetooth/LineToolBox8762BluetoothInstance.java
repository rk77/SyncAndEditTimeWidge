...
public class LineToolBox8762BluetoothInstance implements IBluethoothInstance{
    private static final String TAG = LTUBluetoothInstance.class.getSimpleName();


    public final static String ACTION_GATT_CONNECTED = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_GATT_CHARACTERISTIC_READ = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_CHARACTERISTIC_READ";
    public final static String ACTION_GATT_CHARACTERISTIC_WRITE = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_CHARACTERISTIC_WRITE";
    public final static String ACTION_GATT_DESCRIPTOR_READ = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_DESCRIPTOR_READ";
    public final static String ACTION_GATT_DESCRIPTOR_WRITE = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_DESCRIPTOR_WRITE";
    public final static String ACTION_GATT_MTU_WRITE = "com.rk.commonlib.bluetooth.LineToolBox8762BluetoothInstance.ACTION_GATT_MTU_WRITE";

    private final static String SERVICE_COMMUNICATION_UUID = "0000fff0-0000-1000-8000-00805f9b34fb";
    ...
    private static final long RECV_WAIT_TIMEOUT = 60000;
    ...
    private LineToolBox8762BluetoothInstance() {
        if (sContext != null) {
            ...
            mHandlerThread = new HandlerThread(LTUBluetoothInstance.class.getName() + ".HandlerThread");
    ...
    private static class InstanceHolder {
        private static final LineToolBox8762BluetoothInstance INSTANCE = new LineToolBox8762BluetoothInstance();
    }

    public static LineToolBox8762BluetoothInstance getInstance(Context context) {
