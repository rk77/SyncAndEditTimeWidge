...
public class FusionTerminalBluetoothInstance implements IBluethoothInstance{
    private static final String TAG = FusionTerminalBluetoothInstance.class.getSimpleName();

    public static final String EXTRAS_DEVICE_NAME = "DEVICE_NAME";
    public static final String EXTRAS_DEVICE_ADDRESS = "DEVICE_ADDRESS";

    public final static String ACTION_GATT_CONNECTED = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_GATT_CHARACTERISTIC_READ = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_CHARACTERISTIC_READ";
    public final static String ACTION_GATT_CHARACTERISTIC_WRITE = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_CHARACTERISTIC_WRITE";
    public final static String ACTION_GATT_DESCRIPTOR_READ = "com.rk.commonlib.bluetooth.FusionTerminalBluetoothInstance.ACTION_GATT_DESCRIPTOR_READ";
    ...
    private FusionTerminalBluetoothInstance() {
        if (sContext != null) {
    ...
    private static class InstanceHolder {
        private static final FusionTerminalBluetoothInstance INSTANCE = new FusionTerminalBluetoothInstance();
    }

    public static FusionTerminalBluetoothInstance getInstance(Context context) {
