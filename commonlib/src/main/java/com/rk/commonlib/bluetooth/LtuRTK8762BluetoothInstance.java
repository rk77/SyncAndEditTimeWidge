...
public class LtuRTK8762BluetoothInstance implements IBluethoothInstance{
    ...
    private boolean isReceivedDone(ArrayList<Byte> frame) {
        if (frame != null && frame.size() > 0) {
            ...
            return verify645Frame(tmpFrame);
        }
        return false;
    }
    ...
    private boolean verify645Frame(byte[] frame) {
        ...
        int mSecondBeginPos = mFirstBeginPos + 7;
